...
_Generated: 2026-07-04T18:44:08.112Z_
...
Workspace `mcp.json` _(folder: cinetime-frontend)_

- **c:\Users\sdezc\Documents\B345-347\cinetime-frontend\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\sdezc\.claude.json** — _File exists — no servers defined_
